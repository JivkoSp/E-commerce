    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionCategory", x => x.PromotionCategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OfferId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OfferPercent = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    PromotionCategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offer_PromotionCategory",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_PromotionCategory",
                        column: x => x.PromotionCategoryId,
                        principalTable: "PromotionCategory",
                        principalColumn: "PromotionCategoryId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PriceOfferId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PromoText = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceOffer_Offer",
                        column: x => x.OfferId,
                        principalTable: "Offer",
                        principalColumn: "OfferId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PriceOffer_Product",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewComment_Review",
                        column: x => x.ReviewId,
                        principalTable: "Review",
                        principalColumn: "ReviewId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewComment_ReviewComment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offer_PromotionCategoryId",
                table: "Offer",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewComment_CommentId",
                table: "ReviewComment",
                column: "CommentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_PromotionCategoryId",
                table: "User",
                column: "PromotionCategoryId");
